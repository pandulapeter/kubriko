...
fun Collidable.isCollidingWith(
    other: Collidable
) = if (collisionMask.axisAlignedBoundingBox.withOffset(collisionMask.position)
        .isOverlapping(other.collisionMask.axisAlignedBoundingBox.withOffset(other.collisionMask.position))
) {
