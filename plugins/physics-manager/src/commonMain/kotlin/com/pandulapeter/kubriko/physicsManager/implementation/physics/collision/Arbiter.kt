package com.pandulapeter.kubriko.physicsManager.implementation.physics.collision
...
import com.pandulapeter.kubriko.physicsManager.implementation.physics.dynamics.Physics
...
class Arbiter(
    ...
    fun solve() {
        ...
        jt /= inverseMassSum
        val tangentImpulse: Vec2 = if (abs(jt) < j * staticFriction) {
            t.scalar(jt)
        } else {
