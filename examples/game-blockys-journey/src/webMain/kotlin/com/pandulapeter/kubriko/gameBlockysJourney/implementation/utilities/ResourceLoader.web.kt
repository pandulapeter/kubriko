 ...
 */
package com.pandulapeter.kubriko.gameBlockysJourney.implementation.utilities
...
internal actual fun getResourceUri(path: String, webRootPathName: String): String = getFixedUri(
    path = "composeResources/kubriko.examples.game_blockys_journey.generated.resources/" + path,
