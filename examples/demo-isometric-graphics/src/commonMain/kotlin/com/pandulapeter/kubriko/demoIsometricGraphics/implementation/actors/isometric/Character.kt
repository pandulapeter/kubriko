...
internal class Character(
    ...
    private val bodyParts = listOf(
        ...
        BodyPart(
            ...
            offsetX = -dimensionX * 0.35f,
            offsetY = -dimensionY * 0.15f,
            dimensionXMultiplier = 0.4f,
            dimensionYMultiplier = 0.8f,
            dimensionZMultiplier = 0.12f,
            animation = { phase ->
                offsetY = -dimensionY * 0.1f + dimensionY * FEET_MOVEMENT_HORIZONTAL * phase.sin
        ...
        BodyPart(
            ...
            offsetX = -dimensionX * HAND_DISTANCE_FROM_BODY,
            offsetZ = dimensionZ * 0.33f,
            dimensionXMultiplier = 0.3f,
            dimensionYMultiplier = 0.3f,
            dimensionZMultiplier = 0.15f,
            animation = { phase ->
                offsetY = -dimensionY * HAND_MOVEMENT_HORIZONTAL * phase.sin
                offsetZ = dimensionZ * 0.33f + dimensionZ * HAND_MOVEMENT_VERTICAL * phase.cos - dimensionZ * BODY_MOVEMENT_VERTICAL * 0.75f * phase.sin
            },
        ),
        // Left hand
        BodyPart(
        ...
        BodyPart(
            ...
            offsetX = -dimensionX * 0.25f,
            offsetY = -dimensionY * 0.7f,
