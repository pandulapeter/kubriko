...
/**
 * Use this annotation on property setters of [Editable] Actors to expose those properties to the Editor.
 * @param name - The name the Editor will display on its UI for the property
 */
